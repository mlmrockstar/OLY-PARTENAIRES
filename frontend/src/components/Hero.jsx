    ...
    <section className="oly-container">
      <div className="oly-card oly-card--green px-6 py-16 text-center md:px-16 md:py-20">
        ...
        <p className="oly-sub mx-auto mt-6 max-w-3xl text-white/90">
          ...
          faut aider les gens à créer un changement significatif dans leur vie et
          dans celle des autres. Que vous soyez ici pour soutenir votre santé,
          partager quelque chose auquel vous croyez, ou évoluer vers un nouveau
          rôle, c'est ici que tout commence.
        </p>
        <p className="oly-sub mx-auto mt-6 max-w-3xl text-white/90">
